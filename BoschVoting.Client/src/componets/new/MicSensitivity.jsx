...
const MicSensitivity = (props) => (
    <svg
        width="32px"
        height="32px"
        viewBox="0 -0.03 16.05 16.05"
        xmlns="http://www.w3.org/2000/svg"
        {...props}
    >
        <g color="#000000" fill="black">
            <path
                d="M15.343 4.926l.707.707-.354.354a2.999 2.999 0 0 0 0 4.242l.354.353-.707.707-.354-.353a4 4 0 0 1 0-5.656z"
                style={{
                    lineHeight: "normal",
            ...
            />
            <path
                d="M13.221 2.805l.707.707-.353.353a5.999 5.999 0 0 0 0 8.485l.353.353-.707.707-.353-.353a7 7 0 0 1 0-9.899z"
                style={{
                    lineHeight: "normal",
                    fontVariantLigatures: "normal",
                    fontVariantPosition: "normal",
